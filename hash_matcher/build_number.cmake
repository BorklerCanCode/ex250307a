...
#Reading data from file as generated by entrypoint .sh, e.g.:
#echo "$(date +%Y.%m.%d-%H.%M -u)" > ./CMakeBuildNumberCache.txt #UTC, strictly
IF(EXISTS ${CACHE_FILE})
        file(READ ${CACHE_FILE} BUILD_NUMBER)
ELSE()
        message("build_number.cmake : please populate CMakeBuildNumberCache.txt")
        FATAL_ERROR()
ENDIF()
